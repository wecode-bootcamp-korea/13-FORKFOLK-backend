    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_product', to='product.product')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='product',
            name='orders',
            field=models.ManyToManyField(related_name='orders', through='product.Cart', to='user.Order'),
        ),
        migrations.AddField(
            model_name='cart',
            name='product',
